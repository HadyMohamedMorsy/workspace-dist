...
let AuthenticationGuard = AuthenticationGuard_1 = class AuthenticationGuard {
    constructor(reflector, accessTokenGuard) {
        ...
        this.authTypeGuardMap = {
            [global_enum_1.AuthType.Bearer]: this.accessTokenGuard,
            [global_enum_1.AuthType.None]: { canActivate: () => true },
        };
    }
...
AuthenticationGuard.defaultAuthType = global_enum_1.AuthType.Bearer;
